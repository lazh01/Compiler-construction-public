...
void codeSTATE(STATE *s, frame *fr){
     ...
     switch(s->kind){
          ...
          case incK:
               tvar = requestTemp();
               codeVAR(s->val.incS, fr, tvar);
	          fprintf(f, "   movq @%d, %%rcx\n", tvar->num);
               fprintf(f, "   addq $1, 8(%%rcx)\n");
               break;
          case decK:
               tvar = requestTemp();
               codeVAR(s->val.decS, fr, tvar);
               fprintf(f, "   movq @%d, %%rcx\n", tvar->num);
               fprintf(f, "   subq $1, 8(%%rcx)\n");
               break;
          case forincK:
               tvar = requestTemp();
               codeDECL_LIST(s->val.forincS.first, fr);
               fa = getAccess(s->val.forincS.first->val.varT.left->val.idV, fr);
               getVar(fa, tvar);
               //fprintf(f, "   xor @%d, @%d\n", tvar->num, tvar->num);
               fprintf(f, "   movq $%d, @%d\n", s->val.forincS.second->val.intconstT, tvar->num);
               fprintf(f, "for%d:\n", forcount);
               fprintf(f, "   cmp $%d, @%d\n", s->val.forincS.third->val.intconstT, tvar->num);
               fprintf(f, "   jg forend%d\n", forcount);
               codeSTATE(s->val.forincS.fourth, fr);
               fprintf(f, "   addq $1, @%d\n", tvar->num);
               fprintf(f, "   jmp for%d\n", forcount);
               fprintf(f, "forend%d:\n", forcount);
               forcount++;
          ...
          case fordecK:
               tvar = requestTemp();
               codeDECL_LIST(s->val.fordecS.first, fr);
               fa = getAccess(s->val.fordecS.first->val.varT.left->val.idV, fr);
               getVar(fa, tvar);
               fprintf(f, "   xor @%d, @%d\n", tvar->num, tvar->num);
               fprintf(f, "   movq $%d, @%d\n", s->val.fordecS.second->val.intconstT, tvar->num);
               fprintf(f, "for%d:\n", forcount);
               fprintf(f, "   cmp $%d, @%d\n", s->val.fordecS.third->val.intconstT, tvar->num);
               fprintf(f, "   jl forend%d\n", forcount);
               codeSTATE(s->val.fordecS.fourth, fr);
               fprintf(f, "   subq $1, @%d\n", tvar->num);
               fprintf(f, "   jmp for%d\n", forcount);
               fprintf(f, "forend%d:\n", forcount);
               forcount++;
