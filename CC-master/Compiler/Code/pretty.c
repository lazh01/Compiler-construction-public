...
void prettySTATE(STATE *s){
     switch(s->kind){
          ...
          case incK:
               fprintf(stderr, "%*s", spaces*indendation,"");
               prettyVAR(s->val.incS);
               fprintf(stderr, "++;\n");
               break;
          case decK:
               fprintf(stderr, "%*s", spaces*indendation,"");
               prettyVAR(s->val.decS);
               fprintf(stderr, "--;\n");
               break;
          case forincK:
               fprintf(stderr, "%*s", spaces*indendation,"");
               fprintf(stderr, "for ");
               prettyVAR_TYPE(s->val.forincS.first);
               fprintf(stderr, " ++ [");
               prettyTERM(s->val.forincS.second);
               fprintf(stderr, ",");
               prettyTERM(s->val.forincS.third);
               fprintf(stderr, "]\n");
               indendation++;
               prettySTATE(s->val.forincS.fourth);
               indendation--;
               break;
          case fordecK:
               fprintf(stderr, "%*s", spaces*indendation,"");
               fprintf(stderr, "for ");
               prettyVAR_TYPE(s->val.fordecS.first);
               fprintf(stderr, " -- [");
               prettyTERM(s->val.fordecS.second);
               fprintf(stderr, ",");
               prettyTERM(s->val.fordecS.third);
               fprintf(stderr, "]\n");
               indendation++;
               prettySTATE(s->val.fordecS.fourth);
               indendation--;
               break;
     }
}
