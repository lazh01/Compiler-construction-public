...
STATE *makeSTATEforinc(DECL_LIST *first, TERM *second, TERM *third, STATE *fourth){
    ...
    s->lineno = lineno;
    s->kind = forincK;
    s->val.forincS.first = first;
    s->val.forincS.second = second;
    s->val.forincS.third = third;
    s->val.forincS.fourth = fourth;
    return s;
}
...
STATE *makeSTATEfordec(DECL_LIST *first, TERM *second, TERM *third, STATE *fourth){
    ...
    s->lineno = lineno;
    s->kind = fordecK;
    s->val.fordecS.first = first;
    s->val.fordecS.second = second;
    s->val.fordecS.third = third;
    s->val.fordecS.fourth = fourth;
    return s;
}
