...
void weedSTATE(STATE *s){
     switch(s->kind){
          ...
          case decK:
               ...
               break;
          case forincK:
               fprintf(stderr, "bara ga\n");
               weedDECL_LIST(s->val.forincS.first);
               weedTERM(s->val.forincS.second);
               weedTERM(s->val.forincS.third);
               weedSTATE(s->val.forincS.fourth);
               break;
          case fordecK:
               weedDECL_LIST(s->val.fordecS.first);
               weedTERM(s->val.fordecS.second);
               weedTERM(s->val.fordecS.third);
               weedSTATE(s->val.fordecS.fourth);
               break;
     }
}
